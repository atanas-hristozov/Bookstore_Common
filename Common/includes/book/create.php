...
if (($image == "" && $flag == "") || ($image != "" && $flag == "" )) {
    $query = "INSERT INTO books (isbn, title, author_id, category_id, image, year, description, lang, price, pages, publisher_id, created_at) VALUES" .
            "('$isbn', '$title', '$author', '$category', '$image', '$year', '$description', '$lang', '$price', '$pages', '$publisher', '$date_created')";
